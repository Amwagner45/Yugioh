                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-3 bg-gray-50 rounded-lg">
                                <h4 className="font-medium text-sm text-gray-900 mb-1">Find Blue-Eyes cards</h4>
                                <p className="text-xs text-gray-600">Name contains "Blue-Eyes" OR Archetype equals "Blue-Eyes"</p>
                            </div>
                            <div className="p-3 bg-gray-50 rounded-lg">
                                <h4 className="font-medium text-sm text-gray-900 mb-1">High ATK Dragons</h4>
                                <p className="text-xs text-gray-600">Monster Type equals "Dragon" AND ATK ≥ 2500</p>
                            </div>
                            <div className="p-3 bg-gray-50 rounded-lg">
                                <h4 className="font-medium text-sm text-gray-900 mb-1">Spell/Trap destruction</h4>
                                <p className="text-xs text-gray-600">Card Text contains "destroy" AND (Card Text contains "Spell" OR "Trap")</p>
                            </div>
                            <div className="p-3 bg-gray-50 rounded-lg">
                                <h4 className="font-medium text-sm text-gray-900 mb-1">Exclude certain types</h4>
                                <p className="text-xs text-gray-600">NOT Card Type equals "Token" AND NOT Name contains "Token"</p>
                            </div>
                        </div>
                    </div>
                </div>
