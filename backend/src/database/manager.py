    ...
    def apply_migrations(self) -> bool:
        ...
        try:
            ...
            for migration_file in migration_files:
                ...
                description = (
                    migration_file.name[4:].replace(".sql", "").replace("_", " ")
                )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Yu-Gi-Oh Deck Builder Database Manager"
    )
    parser.add_argument(
        "action",
    ...
    parser.add_argument(
        "--db-path", default="yugioh_deckbuilder.db", help="Path to database file"
    )
