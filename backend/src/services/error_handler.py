        ...
        **kwargs
        ...
        for attempt in range(1, config.max_attempts + 1):
            try:
                ...
                if not self.should_retry(error, config) or attempt == config.max_attempts:
                    break
        ...
        self.logger.error(f"All {config.max_attempts} attempts failed for {operation_type}")
        raise last_error
    ...
    def get_error_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_errors': {
                ...
                for op, timestamp in self.last_errors.items()
            },
