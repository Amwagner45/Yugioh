...
class CacheService:
    ...
    async def get_card_search_results(self, search_params: Dict[str, Any]) -> Optional[List[Dict[str, Any]]]:
        """Get cached card search results"""
        key = self._generate_cache_key("card_search", **search_params)
        return await self.get(key)
    
    async def cache_card_search_results(self, search_params: Dict[str, Any], results: List[Dict[str, Any]]) -> None:
